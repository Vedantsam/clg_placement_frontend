    ...
    <footer className='bg-white border-t border-gray-200 py-10 text-gray-700'>
      <div className='container mx-auto px-4 max-w-7xl'>
        <div className='grid grid-cols-1 md:grid-cols-4 gap-8 items-start text-center md:text-left'>
          {/* Logo and Copyright */}
          <div className=''>
            <h2 className='text-2xl font-extrabold text-[#6A38C2] tracking-wide'>
              Next<span className='text-[#F83002]'>One</span>
            </h2>
            <p className='text-sm mt-2 text-gray-500'>
              © {new Date().getFullYear()} NextOne. All rights reserved.
            </p>
          </div>

          {/* Useful Links */}
          <div className='w-full flex  col-span-2 justify-evenly'>
          <div className='space-y-2'>
            ...
            <ul className='space-y-1 text-sm'>
              <li>
                <a
                  href='/'
                  className='hover:text-[#6A38C2] transition duration-200'
                >
                  Home
                </a>
              </li>
          ...
          <div className='flex justify-center md:justify-end space-x-4'>
            {[
              ...
              },
              {
                ...
                label: 'Twitter',
                svg: <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M24 4.557a9.835 9.835 0 01-2.828.775 4.934 4.934 0 002.165-2.724 9.867 9.867 0 01-3.127 1.195 4.924 4.924 0 00-8.38 4.49A13.978 13.978 0 011.67 3.149 4.93 4.93 0 003.16 9.724a4.903 4.903 0 01-2.229-.616v.062a4.93 4.93 0 003.946 4.827 4.902 4.902 0 01-2.224.084 4.93 4.93 0 004.6 3.417A9.869 9.869 0 010 21.543a13.978 13.978 0 007.548 2.212c9.057 0 14.01-7.507 14.01-14.01 0-.213-.004-.425-.015-.636A10.012 10.012 0 0024 4.557z" /></svg>,
              },
              {
              ...
              <a
                ...
                className='transition transform hover:scale-110 hover:text-[#6A38C2]'
                aria-label={label}
              >
                {svg}
              </a>
